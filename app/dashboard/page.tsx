          ...
          <div className="bg-white p-8 rounded-md max-w-lg w-full">
            ...
            <div className="space-y-4">
              <input
                ...
                onChange={(e) => setCurrentData({ ...currentData, image: URL.createObjectURL(e.target.files[0]) })}
              />
              <input
                type="text"
                placeholder="Name"
              ...
              <input
                ...
                onChange={(e) => setCurrentData({ ...currentData, office: e.target.value })}
              />
              <input
                type="number"
                placeholder="Age"
              ...
              <input
                ...
                onChange={(e) => setCurrentData({ ...currentData, salary: e.target.value })}
              />
            </div>
